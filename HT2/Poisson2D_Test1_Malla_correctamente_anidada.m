...
clear
%TEST 1: MALLA CORRECTAMENTE ANIDADA, EN 8X8 hay problema con MLS
 grid.a1 = 0.0;
 grid.a2 = 0.0;
 grid.b1 = 1.0;
 grid.b2 = 1.0;
 ...
 %Repeticiones en la duplicación de N y M
 Rep_Final = 3;  %Doubling of N and M.
...
fileID1 = fopen('Result_numer_Poisson_2D_MALLA_TEST1_ANIDADA.txt','w');
...
%loop for doubling of N and M
 for RepIni=1:Rep_Final
     ...
     if RepIni==1
         ...
         % ObjHT = New_Mesh2D('Malla_TEST1_Anidada_256x256_3_level.txt',3,grid);
         % ObjHT = New_Mesh2D('Malla_TEST1_Anidada_512x512_3_level.txt',3,grid);      
    ...
    %ENUMERACIÓN POR NIVEL
     ...
     %Versiones finales discretización
     tic;
