...
%TEST 4: MALLA CIRCULAR
%CAMBIAR ARCHIVO .txt DE LECTURA SEGUN LA ENUMERACIÓN 
clear
 grid.a1 = 0.0;
 grid.a2 = 0.0;
 grid.b1 = 1.0;
...
fileID1 = fopen('Result_numer_Poisson_2D_TEST4_MALLA_CIRCULAR.txt','w');
...
%loop for doubling of N and M
 for RepIni=1:Rep_Final
     ...
     if RepIni==1
         ...
         %MALLA EXP 1, TEST 4 EJEMPLO 2 POISSON
         % ObjHT = New_Mesh2D('File_mesh_exp1_32x32_3_leves.txt',3,grid);  %This file has the enumeration for HT creation
         ObjHT = New_Mesh2D('Mesh_circular_TEST4_orden_creation_32x32_level3.txt',3,grid);
         %This file is cration orden but of the cells. 
