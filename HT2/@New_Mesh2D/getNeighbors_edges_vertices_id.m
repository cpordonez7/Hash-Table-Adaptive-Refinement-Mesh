function [List_Neighbors_id] = getNeighbors_edges_vertices_id(HTObj, id)
    %This function returns the id of the neighbors cells referent to id
    ...
    if (ind_i == 0) && (ind_j == 0)
        ...
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i+1,ind_j+1,l,'D4',List_Neighbors_id);
    end
    ...
    if (0 < ind_i && ind_i < N_level-1) && (ind_j == 0)
        ...
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i+1,ind_j,l,'R',List_Neighbors_id);
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i,ind_j+1,l,'A',List_Neighbors_id);
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i-1,ind_j+1,l,'D3',List_Neighbors_id);
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i+1,ind_j+1,l,'D4',List_Neighbors_id);
    end
    ...
    if (ind_i == 0) && (0 < ind_j && ind_j < M_level-1)
        ...
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i+1,ind_j,l,'R',List_Neighbors_id);
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i,ind_j+1,l,'A',List_Neighbors_id);
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i+1,ind_j-1,l,'D2',List_Neighbors_id);
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i+1,ind_j+1,l,'D4',List_Neighbors_id);
    end
    ...
    if (ind_i == N_level-1) && (0 < ind_j && ind_j < M_level-1)
        ...
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i-1,ind_j,l,'L',List_Neighbors_id);
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i,ind_j+1,l,'A',List_Neighbors_id);
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i-1,ind_j-1,l,'D1',List_Neighbors_id);
        List_Neighbors_id = Insert_neighbor(HTObj,ind_i-1,ind_j+1,l,'D3',List_Neighbors_id);
    end
