...
clear
%TEST 2: MALLA GENERAL, EN 8X8 hay problema con MLS
 ...
 N = 8;
 M = 8;
 Rep_Final = 7;  %Doubling of N and M.
...
fileID1 = fopen('Result_numer_Poisson_2D_TEST_2_MALLA_GENERAL.txt','w');
fprintf(fileID1,'\t\t RESULTADOS NUMERICOS POISSON 2D MALLA GENERAL \n\n');
