function [A,b] = discretizeDFPoisson_MLS1(T,pde,ObjHT)
    ...
    fileID3 = fopen('File_cell_with_i_points_MLS1.txt','w');
    ...
    % for j=205:205
        ...
        % for iter=1:n
            ...
            elseif vecinas_cell(2,iter) ~= 0
                ...
                [A,b, num_max_points] = MLS_function_1(T,ObjHT,A,b,ID_CELL_CENT,Id_cel_vecina,pesoh,pesok,m,dl);
                % [A,b] = MLS_function_2(T,ObjHT,A,b,ID_CELL_CENT,Id_cel_vecina,pesoh,pesok,m,dl); %Distancias
