...
%TEST 3: MALLA ALEATORIA, EN 16X16 hay problema con MLS
clear
 grid.a1 = 0.0;
 grid.a2 = 0.0;
 grid.b1 = 1.0;
...
fileID1 = fopen('Result_numer_Poisson_2D_MALLA_TEST3_ALEATORIA.txt','w');
fprintf(fileID1,'\t\t RESULTADOS NUMERICOS POISSON 2D MALLA ALEATORIA TEST 3\n\n');
